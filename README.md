...
```
mvn package
export JAVA_OPTS="$JAVA_OPTS -XX:StartFlightRecording=name=default,dumponexit=true,filename=dump_recording.jfr -Xlog:gc*:file=$(pwd)/target/server/standalone/log/gc.log:time,uptimemillis,level:filecount=5,filesize=3M"
